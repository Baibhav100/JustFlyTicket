  ...
  return (
    <div className='w-[100%] justify-center z-30 items-center'>
      ...
      <div className='fixed w-[100%] z-20 top-0 h-screen bg-black/60 flex justify-center items-center '>
          <div className="z-20 top-[25%] w-[600px] h-[400px] fixed flex justify-center items-center rounded-md bg-white">
          ...
          <img className='text-center relative mt-[20px]' src={require('../images/popup1.png')} alt="" />
           ...
           <p className='text-red-800 font-bold text-5xl'>Call Us !</p>
            <div className='bg-blue-900 rounded-md p-4 mt-4 text-white'>
           ...
           <div className='absolute flex w-[200px] h-[100px] items-center justify-between left-[54%] top-[69%]'>
            <p className='line-through text-red-600'>$400</p>
            <p className='text-5xl font-bold text-blue-950 animate-bounce'>$200</p>
           </div>
        </div>
        <div></div>
