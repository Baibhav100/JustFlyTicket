...
<img  src={require("../images/flight_search_banner.png")} alt="" />
<div className='absolute text-white sm:text-4xl md:text-6xl lg:text-8xl top-[38%] left-[28%]'>
<GiCommercialAirplane />
</div>
<p className='text-white absolute top-0 left-0'>Searching best flight deals ..</p>
<h2 className='absolute text-white md:text-2xl lg:text-4xl font-bold top-[14%] left-[8%]'>{trip1}</h2>
...
<div className='absolute top-[69%] w-[100%]  text-white flex'>
  <div className='absolute left-[8%]  text-[13px] md:text-[16px] lg:text-[18px]'>
    <p className='font-bold'>Departure Date</p>
    <p>{startDate}</p>
  </div>
  <div className={trip1=='oneway'?'hidden':'absolute left-[50%] text-[13px] md:text-[16px] lg:text-[18px]'}>
